    ...
    public class Operations
    {
        ...
        public bool RemoveWorkSheet(string fileName, string sheetName)
        {
            ...
            if (workSheets.Any((workSheetName) => workSheetName.ToLower() == sheetName.ToLower()))
            {
                ...
                {
                    document.SelectWorksheet(document.GetSheetNames().FirstOrDefault((sName) => sName.ToLower() != sheetName.ToLower()));
                }
        ...
        public static bool ImportTabDelimitedTextFile(string textFileName, string excelFileName, string pSheetName)
        {
            try
            {
                ...
                var line = System.IO.File.ReadAllLines(excelFileName).FirstOrDefault();
                /*
