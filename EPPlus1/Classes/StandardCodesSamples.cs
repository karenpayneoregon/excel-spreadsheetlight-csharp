...
public class StandardCodesSamples
{
    ...
    private static string ExcelBaseFolder => "ExcelFiles";

    public static void CreateNewFile()
    {
        var filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, ExcelBaseFolder, "NewFile.xlsx");
    ...
    {
        DataOperations.Contacts(ExcelBaseFolder);
    ...
    public static void Sample1()
    {
        ...
        var filePath = FileUtil.GetFileInfo(ExcelBaseFolder, "Customers.xlsx").FullName;
    ...
    {
        var filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, ExcelBaseFolder, "Customers.xlsx");
        FileInfo existingFile = new(filePath);
        using ExcelPackage package = new(existingFile);
